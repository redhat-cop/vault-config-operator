...
var _ admission.Defaulter[*CertAuthEngineRole] = &CertAuthEngineRole{}

// Default implements webhook.CustomDefaulter so a webhook will be registered for the type
func (r *CertAuthEngineRole) Default(ctx context.Context, obj *CertAuthEngineRole) error {
	certauthenginerolelog.Info("default", "name", obj.Name)
	return nil
}
...
var _ admission.Validator[*CertAuthEngineRole] = &CertAuthEngineRole{}

// ValidateCreate implements webhook.CustomValidator so a webhook will be registered for the type
func (r *CertAuthEngineRole) ValidateCreate(ctx context.Context, obj *CertAuthEngineRole) (admission.Warnings, error) {
	certauthenginerolelog.Info("validate create", "name", obj.Name)
...
func (r *CertAuthEngineRole) ValidateDelete(ctx context.Context, obj *CertAuthEngineRole) (admission.Warnings, error) {
	certauthenginerolelog.Info("validate delete", "name", obj.Name)
