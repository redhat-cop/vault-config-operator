...
func (r *PKISecretEngineRole) ValidateCreate() error {
...
func (r *PKISecretEngineRole) ValidateUpdate(old runtime.Object) error {
...
func (r *PKISecretEngineRole) ValidateDelete() error {
