...
var _ admission.Defaulter[*KubernetesSecretEngineRole] = &KubernetesSecretEngineRole{}

// Default implements webhook.CustomDefaulter so a webhook will be registered for the type
func (r *KubernetesSecretEngineRole) Default(ctx context.Context, obj *KubernetesSecretEngineRole) error {
	kubernetessecretenginerolelog.Info("default", "name", obj.Name)
...
var _ admission.Validator[*KubernetesSecretEngineRole] = &KubernetesSecretEngineRole{}

// ValidateCreate implements webhook.CustomValidator so a webhook will be registered for the type
func (r *KubernetesSecretEngineRole) ValidateCreate(ctx context.Context, obj *KubernetesSecretEngineRole) (admission.Warnings, error) {
	kubernetessecretenginerolelog.Info("validate create", "name", obj.Name)
...
func (r *KubernetesSecretEngineRole) ValidateDelete(ctx context.Context, obj *KubernetesSecretEngineRole) (admission.Warnings, error) {
	kubernetessecretenginerolelog.Info("validate delete", "name", obj.Name)
