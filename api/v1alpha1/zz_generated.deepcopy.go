...
func (in *VaultSecretSpec) DeepCopyInto(out *VaultSecretSpec) {
	*out = *in
	if in.RefreshPeriodOverride != nil {
		in, out := &in.RefreshPeriodOverride, &out.RefreshPeriodOverride
		*out = new(v1.Duration)
		**out = **in
	}
	if in.DefaultRefreshPeriod != nil {
		in, out := &in.DefaultRefreshPeriod, &out.DefaultRefreshPeriod
		*out = new(v1.Duration)
		**out = **in
	}
