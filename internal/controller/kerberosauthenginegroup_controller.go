...
// KerberosAuthEngineGroupReconciler reconciles a KerberosAuthEngineGroup object
type KerberosAuthEngineGroupReconciler struct {
...
func (r *KerberosAuthEngineGroupReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.KerberosAuthEngineGroup{}
...
func (r *KerberosAuthEngineGroupReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.KerberosAuthEngineGroup{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
