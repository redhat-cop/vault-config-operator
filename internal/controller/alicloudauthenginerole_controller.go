...
// AliCloudAuthEngineRoleReconciler reconciles a AliCloudAuthEngineRole object
type AliCloudAuthEngineRoleReconciler struct {
...
func (r *AliCloudAuthEngineRoleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.AliCloudAuthEngineRole{}
...
func (r *AliCloudAuthEngineRoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.AliCloudAuthEngineRole{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
