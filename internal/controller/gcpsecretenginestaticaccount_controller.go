...
// GCPSecretEngineStaticAccountReconciler reconciles a GCPSecretEngineStaticAccount object
type GCPSecretEngineStaticAccountReconciler struct {
...
func (r *GCPSecretEngineStaticAccountReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.GCPSecretEngineStaticAccount{}
...
func (r *GCPSecretEngineStaticAccountReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.GCPSecretEngineStaticAccount{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
