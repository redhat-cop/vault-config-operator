...
// TOTPSecretEngineKeyReconciler reconciles a TOTPSecretEngineKey object
type TOTPSecretEngineKeyReconciler struct {
...
func (r *TOTPSecretEngineKeyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *TOTPSecretEngineKeyReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.TOTPSecretEngineKey{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
