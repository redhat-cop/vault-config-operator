...
// GCPSecretEngineRolesetReconciler reconciles a GCPSecretEngineRoleset object
type GCPSecretEngineRolesetReconciler struct {
...
func (r *GCPSecretEngineRolesetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.GCPSecretEngineRoleset{}
...
func (r *GCPSecretEngineRolesetReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.GCPSecretEngineRoleset{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
