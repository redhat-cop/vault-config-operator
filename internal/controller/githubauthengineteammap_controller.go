...
// GitHubAuthEngineTeamMapReconciler reconciles a GitHubAuthEngineTeamMap object
type GitHubAuthEngineTeamMapReconciler struct {
...
func (r *GitHubAuthEngineTeamMapReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.GitHubAuthEngineTeamMap{}
...
func (r *GitHubAuthEngineTeamMapReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.GitHubAuthEngineTeamMap{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
