...
// RADIUSAuthEngineUserReconciler reconciles a RADIUSAuthEngineUser object
type RADIUSAuthEngineUserReconciler struct {
...
func (r *RADIUSAuthEngineUserReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.RADIUSAuthEngineUser{}
...
func (r *RADIUSAuthEngineUserReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.RADIUSAuthEngineUser{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
