...
//+kubebuilder:rbac:groups=redhatcop.redhat.io,resources=ldapauthenginegroups,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=redhatcop.redhat.io,resources=ldapauthenginegroups/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=redhatcop.redhat.io,resources=ldapauthenginegroups/finalizers,verbs=update
...
// the LDAPAuthEngineGroup object against the actual cluster state, and then
...
func (r *LDAPAuthEngineGroupReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	instance := &redhatcopv1alpha1.LDAPAuthEngineGroup{}
...
func (r *LDAPAuthEngineGroupReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.LDAPAuthEngineGroup{}, builder.WithPredicates(vaultresourcecontroller2.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
