...
// TerraformCloudSecretEngineRoleReconciler reconciles a TerraformCloudSecretEngineRole object
type TerraformCloudSecretEngineRoleReconciler struct {
...
func (r *TerraformCloudSecretEngineRoleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.TerraformCloudSecretEngineRole{}
...
func (r *TerraformCloudSecretEngineRoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.TerraformCloudSecretEngineRole{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
