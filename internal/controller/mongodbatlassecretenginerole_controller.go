...
// MongoDBAtlasSecretEngineRoleReconciler reconciles a MongoDBAtlasSecretEngineRole object
type MongoDBAtlasSecretEngineRoleReconciler struct {
...
func (r *MongoDBAtlasSecretEngineRoleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.MongoDBAtlasSecretEngineRole{}
...
func (r *MongoDBAtlasSecretEngineRoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.MongoDBAtlasSecretEngineRole{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
