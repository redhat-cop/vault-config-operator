...
// ConsulSecretEngineRoleReconciler reconciles a ConsulSecretEngineRole object
type ConsulSecretEngineRoleReconciler struct {
...
func (r *ConsulSecretEngineRoleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.ConsulSecretEngineRole{}
...
func (r *ConsulSecretEngineRoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.ConsulSecretEngineRole{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
