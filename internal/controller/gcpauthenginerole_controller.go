...
// GCPAuthEngineRoleReconciler reconciles a GCPAuthEngineRole object
type GCPAuthEngineRoleReconciler struct {
	vaultresourcecontroller2.ReconcilerBase
}

//+kubebuilder:rbac:groups=redhatcop.redhat.io,resources=gcpauthengineroles,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=redhatcop.redhat.io,resources=gcpauthengineroles/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=redhatcop.redhat.io,resources=gcpauthengineroles/finalizers,verbs=update
...
func (r *GCPAuthEngineRoleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.GCPAuthEngineRole{}
