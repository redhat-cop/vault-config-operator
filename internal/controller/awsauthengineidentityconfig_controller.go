...
// AWSAuthEngineIdentityConfigReconciler reconciles a AWSAuthEngineIdentityConfig object
type AWSAuthEngineIdentityConfigReconciler struct {
...
func (r *AWSAuthEngineIdentityConfigReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.AWSAuthEngineIdentityConfig{}
...
func (r *AWSAuthEngineIdentityConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.AWSAuthEngineIdentityConfig{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
