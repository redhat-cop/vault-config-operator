...
// OCIAuthEngineConfigReconciler reconciles a OCIAuthEngineConfig object
type OCIAuthEngineConfigReconciler struct {
...
func (r *OCIAuthEngineConfigReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = log.FromContext(ctx)

	instance := &redhatcopv1alpha1.OCIAuthEngineConfig{}
...
func (r *OCIAuthEngineConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.OCIAuthEngineConfig{}, builder.WithPredicates(vaultresourcecontroller.NewDefaultPeriodicReconcilePredicate())).
		Complete(r)
}
