...
//+kubebuilder:rbac:groups=redhatcop.redhat.io,resources=quaysecretenginestaticroles,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=redhatcop.redhat.io,resources=quaysecretenginestaticroles/status,verbs=get;update;patch
...
func (r *QuaySecretEngineStaticRoleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// Fetch the instance
	instance := &redhatcopv1alpha1.QuaySecretEngineStaticRole{}
...
func (r *QuaySecretEngineStaticRoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&redhatcopv1alpha1.QuaySecretEngineStaticRole{}, builder.WithPredicates(vaultresourcecontroller2.NewDefaultPeriodicReconcilePredicate())).
		Named("vaultconfigoperator-quaysecretenginestaticrole").
		Complete(r)
}
